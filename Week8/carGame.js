...
var startFuel = reandomNumber(canvas.width, 600);
var fuel = startFuel;
...
function drawResults(){
    ...
    ctx.font = "25px Arial";
    ctx.textAlign = "center";
    ctx.fillText("You make it to the Finish... You Win!", canvas.width/2, canvas.height/2);
...
function reandomNumber(high,low){
